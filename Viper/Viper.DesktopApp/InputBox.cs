...
namespace Viper.DesktopApp
{
    public static class InputBox
    {
        ...
        private static PictureBox Picture(Icon icon)
        {
            ...
            {
                case Icon.Error:
                    folder = @"\images\icon\error.png";
                    break;
                case Icon.Exclamation:
                    folder = @"\images\icon\info.png";
                    break;
                case Icon.Information:
                    folder = @"\images\icon\warning.png";
                    break;
                case Icon.Question:
                    folder = @"\images\icon\question.png";
                    break;
                //case Icon.Nothing:
            ...
            string folderToImage = appPath.Substring(0, appPath.Length - 4) + folder;

            picture.Image = Image.FromFile(folderToImage);
